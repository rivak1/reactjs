            ...
            <section id="videos" className="mt-5">
                <div className="row">
                    <div className="col-md-12">
                        ...
                        <span>Videos</span>
                        <Dropdown className="ml-3 mobile_nav_vi_video" overlay={menu} placement="bottomLeft">
                ...
                <Slider {...settings}>
                    <div className="video_container">
                        <a className="video_box">
                            ...
                            <div className="video_rating"><Rate disabled defaultValue={4.5} /> <b>4.6</b>(1221)</div>
