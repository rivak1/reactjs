...
class HandNotes extends Component {
    constructor(props) {
        super(props) 
        this.state = {
            current:'all',
    ...
    render() {
        ...
        return (
            <section id="handsnotes" className="mt-5">
                <div className="row">
                    <div className="col-md-12">
                        <h2 className="d-flex justify-content-start text-muted">
                        <span>Hands Notes</span>
                        <Dropdown className="mobile_nav_vi_hand" overlay={menu} placement="bottomLeft">
                            <img height="25" className="ml-3 mt-2" src="https://res.cloudinary.com/hg3trlxnt/image/upload/v1592372242/filter_qa8sxe.svg" alt="FILTER-ICON"/>
                        </Dropdown>
                        </h2>
                ...
                <Slider {...settings}>
                    <div className="hand_container">
                        <a className="hand_box">
                            ...
                            <div className="hand_author">
                                <p>Rivak Shah</p>
                            </div>
                            <div className="hand_rating"><Rate disabled defaultValue={4.5} /> <b>4.6</b>(1221)</div>
